...
static const int64 MAX_MONEY = 200*10000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 17280 / 250; // 5760 blocks found a day. Priority cutoff is 1 SMC day / 250 bytes.
    }
