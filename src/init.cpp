    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("FooCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  bridgecoin [options]                     " + "\n" +
                  "  bridgecoin [options] <command> [params]  " + _("Send command to -server or bridgecoin") + "\n" +
                  "  bridgecoin [options] help                " + _("List commands") + "\n" +
                  "  bridgecoin [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "bridgecoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: bridgecoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: bridgecoin.pid)") + "\n" +
...
//    }
    ...
    // Make sure only a single bridgecoin process is using the data directory.
    ...
    // requested to kill bridgecoin-qt during the last operation. If so, exit.
